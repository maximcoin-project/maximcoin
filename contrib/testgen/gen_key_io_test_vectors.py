...
bech32_templates = [
  ...
  ('mxc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('mxc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('mxc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tmxc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tmxc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tmxc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rmxc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rmxc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rmxc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tmxc',  17, 32, False, False, False),
  ('rmxc',  3,  1, False, False, False),
  ('mxc',   15, 41, False, False, False),
  ('tmxc',  0, 16, False, False, False),
  ('rmxc',  0, 32, True,  False, False),
  ('mxc',   0, 16, True,  False, False),
  ('tmxc',  0, 32, False, True,  False),
  ('rmxc',  0, 20, False, False, True)
]
