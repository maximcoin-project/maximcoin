...
Then, to tunnel a SSL connection on 28378 to a RPC server bound on localhost on port 18378 do:

    stunnel -d 28378 -r 127.0.0.1:18378 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        ProxyPassReverse http://127.0.0.1:8378/
