# Support for Output Descriptors in Maximcoin Core

Since Maximcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `mxc1...` for mainnet or `tmxc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Maximcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Maximcoin Core wallets, a convenience function `combo` is
