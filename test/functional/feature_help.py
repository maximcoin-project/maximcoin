...
"""Verify that starting maximcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start maximcoin with -h for help text")
        ...
        self.log.info("Start maximcoin with -version for version information")
        ...
        self.log.info("Start maximcoind with -fakearg to make sure it does not start")
