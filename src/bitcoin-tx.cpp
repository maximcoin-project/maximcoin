...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " maximcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  maximcoin-tx [options] <hex-tx> [commands]  Update hex-encoded maximcoin transaction\n" +
            "or:     maximcoin-tx [options] -create [commands]   Create hex-encoded maximcoin transaction\n" +
            "\n";
