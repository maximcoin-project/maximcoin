...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"); //1683528
        ...
        **/
        ...
        vSeeds.emplace_back("dnsseed.dnsseed.maximcoin.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testdnsseed.maximcoin.org");
        ...
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,110); //m
